...
$dbname = "postgres";
$user = "postgres";
$password = "uddhav taur7777"; // Ensure this is correct; avoid spaces or escape them
...
try {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO contact (name, email, phone, enquiry_type, message) VALUES (:name, :email, :phone, :enquiry_type, :message)";
